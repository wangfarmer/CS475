...
public interface CalendarMgrIntr<T, E> extends Remote {
	...
	public void createNewTimer(Calendar startDate, String description, String accessControl) throws RemoteException;
	
	public  boolean checkUserList(String username) throws RemoteException;
