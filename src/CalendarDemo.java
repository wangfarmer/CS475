	...
	public static void main(String[] args) {
		...
		while(checkInsertStatus){
			...
			case "yes":
				...
				for (CalendarObject e : newManager.getCalendar()){
			...
			while(checkLoginStatus){
				...
				while(checkActionStatus){
					...
					case "display":
						...
						retrieveStartDateInput.set(2017,4,4,hourRetrieveStartInput,minRetrieveStartInput);
						Calendar retrieveEndDateInput = Calendar.getInstance();
						retrieveEndDateInput.set(2017,4,4,hourRetrieveEndInput,minRetrieveEndInput);
					...
					case "schedule":
						...
						scheduleStartDateInput.set(2017,4,4,hourScheduleStartInput,minScheduleStartInput);
						Calendar scheduleEndDateInput = Calendar.getInstance();
						scheduleEndDateInput.set(2017,4,4,hourScheduleEndInput,minScheduleEndInput);
							
						EventObj newEvent = new EventObj(scheduleStartDateInput,scheduleEndDateInput,descriptionScheduleInput,accessControlScheduleInput);
						try{
					...
					case "delete":
						...
						DeleteStartDateInput.set(2017,4,4,hourDeleteStartInput,minDeleteStartInput);
						Calendar DeleteEndDateInput = Calendar.getInstance();
						DeleteEndDateInput.set(2017,4,4,hourDeleteEndInput,minDeleteEndInput);
						
						try{
							if(nameDeleteInput.equalsIgnoreCase(userNameInput)){
								LinkedList<EventObj> testDelete2 = newManager.deleteOwnEvent(nameDeleteInput, DeleteStartDateInput, DeleteEndDateInput);
								System.out.println(nameDeleteInput + "'s eventlist:");
								System.out.println(testDelete2.toString());
							}else{
								LinkedList<EventObj> testDelete2 = newManager.deleteOthersEvent(nameDeleteInput, DeleteStartDateInput, DeleteEndDateInput);
